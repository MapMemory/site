...
import '../styles/light/green/privacy.scss'
...
function Body() {
    return (
		...
		отношении всей информации, которую сайт <b>MapMemory</b>, (далее – MapMemory) расположенный на
		доменном имени <b>MapMemory.com</b> (а также его субдоменах), может получить о Пользователе во время использования
		...
		на управление сайтом <b>MapMemory</b>,
		...
		наличия иного законного основания.</p>
            ...
            <p>1.1.5. «Сайт <b> MapMemory</b>» - это совокупность связанных между собой веб-страниц, размещенных в сети Интернет по уникальному
		адресу (URL): <b>MapMemory.com</b>, а также его субдоменах.</p>
		...
		информация Администрации</p>
            ...
            <p>1.1.5. «Пользователь сайта <b>MapMemory</b> » (далее Пользователь) – лицо, имеющее доступ
		к сайту <b>MapMemory</b>, посредством сети Интернет
		и использующее информацию, материалы и продукты сайта <b>MapMemory</b>.</p>
		...
		регистрации на сайте MapMemory или при подписке на информационную e-mail рассылку.</p>
            ...
            Пользователем путём заполнения форм на сайте MapMemory и включают в себя следующую информацию:
		...
		адресу: needtochange@gmail.com</p>

            <p>9.4. Действующая Политика конфиденциальности размещена на странице по адресу http://MapMemory.com/politika.html</p>

            <p>Обновлено: 05 Мая 2021 года</p>
            <p>г. Минск, NeedToChange</p>
